...
draw_sprite_ext(spr_pause_vine, ui_index, (obj_screensizer.actual_width / 2), vine_y, 1, 1, 0, c_white, 1)
...
if (transfotext != -4 && (!instance_exists(obj_achievement_pause)))
{
    ...
    xx = floor(xx)
    yy = floor(yy)
    global.tdp_text_try_outline = 1
    scr_draw_text_arr(xx, yy, transfotext, 16777215, fade)
    global.tdp_text_try_outline = 0
    tdp_text_commit(0, 0, obj_screensizer.actual_width, obj_screensizer.actual_height)
    draw_set_alpha(1)
}
pause_draw_priests()