...
if (global.dosavestates)
    array_push(str, "SAVESTATES ENABLED   ")
...
for (var i = array_length(str) - 1; i >= 0; i--)
{
    ...
    draw_text((obj_screensizer.actual_width - len * string_width("A")), (obj_screensizer.actual_height - 8 - string_height("A") * yy), b)
    yy++
}